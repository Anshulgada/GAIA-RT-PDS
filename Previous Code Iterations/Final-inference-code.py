...
def process_video(model, input_path, output_path, frame_skip=5):
    # Load the video
...
if __name__ == "__main__":
    ...
    if args.input_type == 'img':
        ...
        process_video(model, args.input_path, args.output_path, frame_skip=args.frame_skip)

# python3 yolo-inference-script.py --weights best.pt --input-type video --input-path /home/gaia/Desktop/PDS/videoplayback.mp4 --output-path /home/gaia/Desktop/PDS/videoplayback-res-low-fps.mp4 --frame-skip 5